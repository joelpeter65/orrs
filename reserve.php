    ...
    <div class="card rounded-0 card-outline card-primary shadow">
        ...
        <div class="card-body rounded-0">
            ...
            <form action="" id="reserve-form">
                <input type="hidden" name="schedule_id" value=<?= isset($id) ? $id : "";$_SESSION['iding'] = $id;?>>
                ...
                <div class="row justify-content-between my-2">
                    <div class="form-group">
                        ...
                        <!-- <a class="btn btn-flat btn-sm btn-warning" href="pending" style="text-decoration: none;"><i class="fa fa-list"></i> Pending</a> -->
                    </div>
                    <div class="form-group">
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(resp.status == 'success'){
                        ...
                        location.href = "./?page=pay&ids="+resp.ids
                    }else if(!!resp.msg){
